...
ActiveRecord::Schema.define(version: 2019_02_02_123941) do
  ...
  create_table "opinions", force: :cascade do |t|
    ...
    t.index ["user_id", "comment_id"], name: "index_opinions_on_user_id_and_comment_id", unique: true
  ...
  add_foreign_key "opinions", "comments"
